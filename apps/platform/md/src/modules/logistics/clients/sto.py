...
class StoClient(BaseExpressClient):
    """STO Express API client."""
    ...
    def get_tracking_url(self, tracking_number: str) -> str:
        """Get STO tracking URL."""
        return f"https://www.sto.cn/track?billCode={tracking_number}"
    ...
    async def query_tracking(
        ...
        """Query STO tracking information."""
        logger.info(f"Querying STO tracking for: {tracking_number}")
