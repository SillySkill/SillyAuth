...
class YundaClient(BaseExpressClient):
    """Yunda Express API client."""
    ...
    def get_tracking_url(self, tracking_number: str) -> str:
        """Get Yunda tracking URL."""
        return f"https://www.yunda56.com/track?billCode={tracking_number}"
    ...
    async def query_tracking(
        ...
        """Query Yunda tracking information."""
        logger.info(f"Querying Yunda tracking for: {tracking_number}")
